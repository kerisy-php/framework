...
class Kerisy_Image_ImageMagick extends Kerisy_Image {
	...
	public static function check()
	{
		...
		{
			show_error('Imagick is not installed, or the extension is not loaded');
		}

		return Kerisy_Image_ImageMagick::$_checked = TRUE;
	}
	...
	{
		if ( ! Kerisy_Image_ImageMagick::$_checked)
		{
			// Run the install check
			Kerisy_Image_ImageMagick::check();
		}
	...
	protected function _do_sharpen($amount)
	{
		...
		return $this->im->sharpenImage(($amount>=2) ? 1 : 0, $amount);
	}
	...
	protected function _get_imagetype($extension)
	{
		...
		switch ($format)
		{
			...
			break;
			default:
				show_error('Installed ImageMagick does not support :type images');
			break;
		}
