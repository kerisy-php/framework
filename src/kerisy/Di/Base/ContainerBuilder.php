...
namespace Kerisy\Di\Base;

use Kerisy\Di\Base\Compiler\Compiler;
use Kerisy\Di\Base\Compiler\CompilerPassInterface;
use Kerisy\Di\Base\Compiler\PassConfig;
use Kerisy\Di\Base\Exception\BadMethodCallException;
use Kerisy\Di\Base\Exception\InvalidArgumentException;
use Kerisy\Di\Base\Exception\LogicException;
use Kerisy\Di\Base\Exception\RuntimeException;
use Kerisy\Di\Base\Exception\ServiceCircularReferenceException;
use Kerisy\Di\Base\Exception\ServiceNotFoundException;
use Kerisy\Di\Base\Extension\ExtensionInterface;
//use Symfony\Component\Config\Resource\FileResource;
//use Symfony\Component\Config\Resource\ResourceInterface;
//use Kerisy\Di\Base\LazyProxy\Instantiator\InstantiatorInterface;
//use Kerisy\Di\Base\LazyProxy\Instantiator\RealServiceInstantiator;
