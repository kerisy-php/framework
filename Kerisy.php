...
class Kerisy
{
    ...
    public static function init()
    {
        ...
        $import_prefix = Kerisy::config()->get()->import_prefix;
        if (isset($import_prefix) && is_array($import_prefix)) {
            self::setImportPrefix($import_prefix);
        }

        $use_classes = Kerisy::config()->get()->use_classes;
        if (isset($use_classes) && is_array($use_classes)) {
    ...
    {
        return self::loadClass('Kerisy_Cookie');
    }
    ...
    public static function loadClass($class_name)
    {
        ...
        if (isset(self::$_classes[$class_name]) && self::$_classes[$class_name]) {
